 ...
 * @author User
 */
public class CardapioSobremesa extends javax.swing.JFrame {

    private static CardapioSobremesa cpsUnic;
    
    public CardapioSobremesa() {
        initComponents();
        setLocationRelativeTo( null );
        setDefaultCloseOperation(CardapioSobremesa.DISPOSE_ON_CLOSE);
        listTab();
    }

    //Singleton
    public static CardapioSobremesa geraCardapioSobremesa(){
        if(cpsUnic == null){
            cpsUnic = new CardapioSobremesa();
        }
        return cpsUnic;
    }
    /**
    ...
    private void initComponents() {
        ...
        tbCardapioSobremesa = new javax.swing.JTable();
        ...
        tbCardapioSobremesa.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Nº", "Sobremesa", "g", "Preco"
            }
        ));
        jScrollPane1.setViewportView(tbCardapioSobremesa);
    ...
    private void btProxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProxActionPerformed
        Conta.geraConta().setVisible(true);
        dispose();
    ...
    private void btPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPedidoActionPerformed
       try {
        ...
        if (numeroItemStr != null) {
            ...
            DefaultTableModel modelo = (DefaultTableModel)tbCardapioSobremesa.getModel();
    ...
    public void listTab(){
        ...
        GerSobremesa gerSobremesa = GerSobremesa.geraGerSob();
        for(Sobremesa s1 : gerSobremesa.getbdSobremesa()){
            modelo.insertRow(posLin, new Object[]{count+1,s1.getNome(), s1.getPeso(), s1.getPreco()});
            posLin++;
            count++;
        }    
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CardapioSobremesa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CardapioSobremesa().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbCardapioSobremesa;
