...
public class CadNaoAlcoolico extends javax.swing.JFrame {

    private static CadNaoAlcoolico cnaUnic;
    private GerNaoAlcoolico gna = GerNaoAlcoolico.geraGerNaoAlc();
    private NaoAlcoolico na1 = new NaoAlcoolico();
    
    
    public CadNaoAlcoolico() {
        initComponents();
        setLocationRelativeTo( null );
        setDefaultCloseOperation(CadNaoAlcoolico.DISPOSE_ON_CLOSE);
    }

    //Singleton
    public static CadNaoAlcoolico geraCadNaoAlcoolico(){
        if(cnaUnic == null){
            cnaUnic = new CadNaoAlcoolico();
        }
        return cnaUnic;
    }
    ...
    private void initComponents() {
        ...
        tbNaoAlcoolico = new javax.swing.JTable();
        ...
        lbMenuGerente.setText("CADASTRAR BEBIDA");
        ...
        tbNaoAlcoolico.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jScrollPane2.setViewportView(tbNaoAlcoolico);
    ...
    public void ins() {
    try {
        na1 = new NaoAlcoolico();
        na1.setPreco(Float.parseFloat(cxValor.getText()));
        na1.setNome(cxNome.getText());
        na1.setVolume(Float.parseFloat(cxTamanho.getText()));
        na1 = gna.insNaoAlcoolico(na1);
    ...
    public void alterar() {
        try {
            na1 = new NaoAlcoolico();
            na1.setNome(cxNome.getText());
            na1 = gna.atualizaNaoAlcoolico(na1);
...
public void consultar() {
    try {
        na1 = new NaoAlcoolico();
        na1.setNome(cxNome.getText());
        na1 = gna.consNaoAlcoolico(na1);

        if (na1 != null) {
            cxValor.setText(Float.toString(na1.getPreco()));
            cxNome.setText(na1.getNome());
            cxTamanho.setText(Float.toString(na1.getVolume()));
   ...
   public void excluir() {
    ...
    public void listTab(){
        DefaultTableModel modelo = (DefaultTableModel)tbNaoAlcoolico.getModel();
        int posLin =0;
        modelo.setRowCount(posLin);
        for(NaoAlcoolico na1 : gna.getbdNaoAlcoolico()){
            modelo.insertRow(posLin, new Object[]{na1.getNome(),na1.getPreco(),na1.getVolume()});
            posLin++;
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadNaoAlcoolico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadNaoAlcoolico().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbNaoAlcoolico;
