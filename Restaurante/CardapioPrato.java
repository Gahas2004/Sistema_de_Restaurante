 ...
 * @author User
 */
public class CardapioPrato extends javax.swing.JFrame {

    private static CardapioPrato cppUnic;
    
    public CardapioPrato() {
        initComponents();
        setLocationRelativeTo( null );
        setDefaultCloseOperation(CardapioPrato.DISPOSE_ON_CLOSE);
        listTab();
    }

    //Singleton
    public static CardapioPrato geraCardapioPrato(){
        if(cppUnic == null){
            cppUnic = new CardapioPrato();
        }
        return cppUnic;
    }
    /**
    ...
    private void initComponents() {
        ...
        tbCardapioPrato = new javax.swing.JTable();
        ...
        tbCardapioPrato.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tbCardapioPrato);
    ...
    private void btProxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProxActionPerformed
        CardapioSobremesa.geraCardapioSobremesa().setVisible(true);
        dispose();
    ...
    private void btPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPedidoActionPerformed
        ...
        if (numeroItemStr != null) {
            ...
            DefaultTableModel modelo = (DefaultTableModel)tbCardapioPrato.getModel();
    ...
    public void listTab(){
        ...
        GerPrato gerPrato = GerPrato.geraGerPrato();
        for(Prato p1 : gerPrato.getbdPrato()){
            modelo.insertRow(posLin, new Object[]{count+1,p1.getNome(), p1.getPeso(), p1.getPreco()});
            posLin++;
            count++;
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CardapioPrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CardapioPrato().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbCardapioPrato;
